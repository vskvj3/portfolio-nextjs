...
export default function Post({ postData }) {
  return (
    <>
      ...
      <div className="bg-dracula-foreground/35 backdrop-blur-md min-w-[370px] h-auto max-w-[1000px] mx-10 mb-2 lg:mb-5 p-[20px] rounded-md text-left text-dracula-t-white">
